...
TOKEN = '7804440324:AAHHKYBpqEgVe0ofHkDCA2nK_cOilysflqQ'
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣JALDI ATTACK MAAR BAHI KISI NE BHI NI LAGA RAKHA *\n"  # Ready to launch message
                                   ...
                                   "*OWNER @🧛*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀PING DEKH NICHE 677 HOGYA !👻*\n\n"  # Attack launched message
                                           f"*TIME ==> {duration} seconds send feedback to @error_userrr🔥*", parse_mode='Markdown')  # Duration message
